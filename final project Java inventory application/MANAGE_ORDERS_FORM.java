    ...
    private void jButton_INSERT_ORDER_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_INSERT_ORDER_ActionPerformed
     ...
     String pickupDate ="";
       ...
       if(jDateChooser2.getDate() != null){
           pickupDate = dateFormat.format(jDateChooser2.getDate());
       ...
       else if(jTable_PRODUCTS_IN_ORDER_.getRowCount() > 0)
        {
            ...
            // insert the order
            CLASS.THE_ORDER.insertOrder(orderId, orderDate, Integer.valueOf(jTextField_CUSTOMER_ID.getText()),pickupDate);
